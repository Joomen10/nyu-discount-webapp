...
class Users(models.Model):
    ...
    password = models.CharField(max_length=255, default=make_password("defaultpassword"))  # ✅ Add hashed default
    school = models.CharField(max_length=255, default="NYU")
    grade = models.CharField(max_length=20, default="Freshman")  # ✅ Add default grade
